...
export function QuickLog({ isOpen, onClose, preselectedItemIds = [] }: Props) {
  ...
  return (
    <BottomSheet isOpen={isOpen} onClose={onClose} title="What did you wear?">
      {feedback && (
        <div
          aria-live="polite"
          className="absolute inset-0 z-10 -m-6 flex flex-col items-center justify-center gap-3 rounded-t-4xl bg-card"
        >
          <span
            className={
